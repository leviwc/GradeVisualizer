...
export const artes_cenicas_direcao = {
  semestre: [
    {
      numero: "1",
      materias: [
...

    {
      ...
      materias: [
        ...
        },
        {
          id: "2",
          codigo: "TEAA24",
          nome: "Laboratório de Direção Teatral: A Cena Fechada",
          state: GradeState.NEUTRAL,
          dependencias: [
            { id: "0", numero: "3" },
            { id: "0", numero: "2" },
...

    {
      ...
      materias: [
        ...
        },
        {
          id: "1",
          codigo: "TEAA23",
          nome: "Laboratório de Direção Teatral: A Cena Aberta",
          state: GradeState.NEUTRAL,
          dependencias: [
            { id: "0", numero: "3" },
            { id: "0", numero: "2" },
...

    {
      ...
      materias: [
        ...
        },
        {
          id: "1",
          codigo: "TEAA25",
          nome: "Laboratório de Direção Teatral: Teatro Rito e Performance",
          state: GradeState.NEUTRAL,
          dependencias: [
            { id: "0", numero: "3" },
            { id: "0", numero: "2" },
...

    {
      ...
      materias: [
        ...
        },
        {
          id: "1",
          codigo: "TEAA26",
          nome: "Direção de Espetáculo Teatral I",
          state: GradeState.NEUTRAL,
          dependencias: [
            { id: "0", numero: "4" },
            { id: "0", numero: "6" },
      ...
      materias: [
        {
          id: "0",
          codigo: "TEAA44",
          nome: "Direção de Espetáculo Teatral II",
          state: GradeState.NEUTRAL,
          dependencias: [
            { id: "0", numero: "4" },
            { id: "0", numero: "6" },
